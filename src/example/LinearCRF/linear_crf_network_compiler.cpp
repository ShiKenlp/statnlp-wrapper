...
LinearCRFInstance* LinearCRFNetworkCompiler::Decompile(Network *ptr_network) {
    ...
    std::cout<<"ptr_generic_network_:"<<ptr_generic_network_->CountNodes()<<std::endl;
    node_k = ptr_generic_network_->BinarySearch(num_node,root);
    //node_k = ptr_network->BinarySearch(ptr_network->CountNodes(),root);
