...
FeatureArray* LinearCRFFeatureManager::ExtractHelper(Network *ptr_network, int parent_k, std::vector<int> children_vec ) {
    ...
    int child_tag_id = (ptr_network->GetNodeArray(children_vec[0]))[1];
