...
LinearCRFNetwork::LinearCRFNetwork(int networkid, LinearCRFInstance *ptr_inst, TableLookupNetwork *ptr_network,LocalNetworkParam *ptr_param, int num_nodes):TableLookupNetwork(networkid,ptr_inst,ptr_network,ptr_param, num_nodes) {
